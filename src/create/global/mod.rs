...
use super::structs::{ComponentCreation, ComponentCreationPaths, ComponentExports};
  ...
  pub fn make_component(&self) -> Result<String> {
    ...
    let component = match tool {
      ...
      Tool::Svelte => {
        ...
        let script = Some(ComponentCreationPaths {
